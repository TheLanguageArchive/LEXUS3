/**
 * AAM: This component extends the Flex List for measuring the width of all the renderers so the scrollbars are calculated correctly. 
 *  It fixes a bug with the horizontal scroolbars in the Flex List component. See LEXUS bug 314.
 *  The problem is that in a List (and other List-based components), when you set the horizontalScrollPolicy to auto, 
 ...
 *  This component should be used insted of the original List every time horizontall scrollbar problems are found,
...
package nl.mpi.lexus{
	...
	public class AutoSizeList extends List
	{
		public function AutoSizeList(){
			super();
		...
		// List's maxHorizontalScrollPosition adds an indent value to it,
